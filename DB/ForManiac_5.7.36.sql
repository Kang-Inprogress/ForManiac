...
CREATE TABLE IF NOT EXISTS `ForManiac`.`POST` (
  ...
  INDEX `fk_POST_Fields1_idx` (`Fields_FIELD_number` ASC),
...
CREATE TABLE IF NOT EXISTS `ForManiac`.`COMMENTFIELDS` (
  ...
  INDEX `fk_COMMENTFIELDS_POST1_idx` (`POST_POST_number` ASC, `POST_Fields_number` ASC),
...
CREATE TABLE IF NOT EXISTS `ForManiac`.`COMMENTFIELDS_has_USERS` (
  ...
  INDEX `fk_COMMENTFIELDS_has_USERS_USERS1_idx` (`USERS_USER_number` ASC),
  INDEX `fk_COMMENTFIELDS_has_USERS_COMMENTFIELDS1_idx` (`COMMENTFIELDS_COMMENTFIELDS_number` ASC),
...
CREATE TABLE IF NOT EXISTS `ForManiac`.`USERS_has_Fields` (
  ...
  INDEX `fk_USERS_has_Fields_Fields1_idx` (`Fields_FIELD_number` ASC),
  INDEX `fk_USERS_has_Fields_USERS1_idx` (`USERS_USER_number` ASC),
